...
$timezone = trim("Africa/Cairo");

putenv("TZ=$timezone");

// Counting down to New Year's on 2020
$countdown_to = trim("2020-01-01 00:00:00"); // 24-Hour Format: YYYY-MM-DD HH:MM:SS"
...
function do_cd(iid)
{
	...
	{ 	
		...
		?>
		// change text
		document.getElementById('cd'+iid).innerHTML = "<?=$_GET['data']?>";
		<?php } ?>

	}	
	else	
	{	
		document.getElementById('cd'+iid).innerHTML = convert_to_time(countdown);
		setTimeout('do_cd('+iid+');', 1000);
	}	
